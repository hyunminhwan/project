    ...
    return (
        <div className="Login_Form">
            ...
            <form onSubmit={loginOn}>
                ...
                <div>
                    <Button variant="outline-danger" type="button" onClick={() => navigate("/signup")}>회원가입</Button>
                    <Button variant="outline-danger" type="button" onClick={() => navigate("/findid")}>아이디 찾기</Button>
                    <Button variant="outline-danger" type="button" onClick={() => navigate("/findpwd")}>비밀번호 찾기</Button>
                </div>
            </form>
        </div>
    );
