    ...
    <div id="fullpage">
      ...
      <div className="section">
        <section className="theme-cards">
          <br />
          <h2 className="theme-h2"> TEMA</h2>
          <div className="theme-cards-container">
            {themes.map((theme, index) => (
              <div className="theme-card" key={index} onClick={() => { themeDetail(theme) }}>
      ...
      <div className="section">
        <section className="notice-event">
          <div className="notice">
            <br /><br /><br />
            <h2 id="NoticeText">Notice</h2> <br />
            <p id="NoticeText1">노약자, 임산부, 폐쇄공포증, 보호자 미동반 어린이<br /> 음주자는 입장이 제한됩니다.</p>
            <br /> <br /><br /><br />
            <div className="notice-icons">
              <div className="icon-item">
                <img src={clockImg} alt="Clock Icon" />
                <p id="FONT">도착시간 엄수</p>
                <p className="FONT_P">게임 준비와 설명을 위하여<br />게임시작 시간 최소 10분 전에<br />도착해주셔야 합니다.<br /><br /><br /></p>
              </div>
              <div className="icon-item">
                <img src={photoImg} alt="Photo Icon" />
                <p id="FONT">촬영 금지 및 소지품 보관</p>
                <p className="FONT_P">소품 및 인테리어는<br />컨텐츠 보호를 위해 사진 촬영을<br />금지하고 있습니다.<br />게임 입장 전 소지품을 보관함에<br />보관해주세요.</p>
              </div>
              <div className="icon-item">
                <img src={cctvImg} alt="Cctv Icon" />
                <p id="FONT">CCTV 녹화중</p>
                <p className="FONT_P">안전한 방탈출과 원활한<br />게임진행을 위해,<br />테마 내 모든 구간은<br />CCTV를 통해 녹화되고 있습니다.<br /></p>
              </div>
              <div className="icon-item">
                <img src={groupImg} alt="Group Icon" />
                <p id="FONT">스포 금지</p>
                <p className="FONT_P">테마 내의 모든 내용 및 문제는<br />다른 손님들을 위해<br />유출을 절대 금지합니다.<br /><br /></p>
              </div>
            </div>
          </div>
        </section>
